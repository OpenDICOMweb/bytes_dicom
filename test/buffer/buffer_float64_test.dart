...
void main() {
  ...
  group('BytesDicom Float64 Tests', () {
    test('DicomReadBuffer BytesDicomLE Float64 tests', () {
      for (var i = 0; i < repetitions; i++) {
        ...
        final vList1 = rBuf1.readFloat64List(vList0.length);
        expect(vList1, equals(vList0));
      }
    });

    test('DicomReadBuffer BytesDicomBE Float64 tests', () {
      for (var i = 0; i < repetitions; i++) {
        final vList0 = rng.float64List(min, max);
